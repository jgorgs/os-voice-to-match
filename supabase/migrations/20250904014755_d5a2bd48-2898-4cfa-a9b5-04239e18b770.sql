...
) AS candidate_data(candidate_id, overall_score, skills_score, experience_score, location_score, company_score, status, rank_position, score_breakdown);